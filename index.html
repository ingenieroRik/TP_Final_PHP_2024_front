...
<body>
    ...
    <main id="main" class="main">
        ...
        <section data-aos="fade-up" data-aos-offset="300" data-aos-delay="50" data-aos-duration="1000" class="buscadorPrincipal">
            ...
            <!--   buscador de peliculas por titulo y descripcion -->
            <form class="buscadorPeliculas" action="" id="form-buscar">
    ...
    <footer class="footer">
        <nav class="navegacion">
            <ul class="listaNav">
                ...
                <li class="listaItem"><a class="linkNav administradorPeliculas" href="/pages/inicioAdmin.php">Administrador Peliculas</a></li>
            </ul>
        </nav>
    ...
    <!--script que trae peliculas de un servidor de tercero y crea cada pelicula en el dom-->
    <script  type="module" src="./js/cargar_peliculas_index.js"></script>
